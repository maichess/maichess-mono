...
- `Fen.decode`, `San.decode/encode`, `Pgn.decode`, `GameController.applyMove`, `SharedGameModel.importFen/importPgn` — all return `Either[String, T]` or `Either[IllegalMove, T]`, pushing error handling to the caller.
